...
package at.crowdware.bookdesigner.utils

import at.crowdware.bookdesigner.projects.ProjectManager
import at.crowdware.bookdesigner.util.*
...
fun deserializePage(parsedResult: List<Any>): Page {
    ...
    val theme = ProjectManager.app?.theme
...
val fontWeightMap = mapOf(
    ...
    "extrabold" to FontWeight.EXTRA_BOLD,
    "extralight" to FontWeight.EXTRA_LIGHT,
...
val textAlignMap = mapOf(
    "left" to TextAlignment.LEFT,
    "center" to TextAlignment.CENTER,
    "right" to TextAlignment.RIGHT,
							...
							elements.add(
								UIElement.TextElement(
									...
									color = (properties["color"] as? PropertyValue.StringValue)?.value
										?: theme.onBackground,
									fontSize = (properties["fontSize"] as? PropertyValue.IntValue)?.value ?: 14,
